<template>
  <div class="min-h-screen bg-gradient-to-br from-indigo-50/50 via-gray-50 to-white py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-2xl mx-auto bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
      ...
      <div class="px-8 py-6 border-b border-gray-100 flex items-center justify-between bg-white/50">
        <h2 class="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-purple-600">Profile Settings</h2>
      ...
      <div class="p-8 space-y-8">
        ...
        <div class="flex flex-col items-center space-y-4">
          <div class="relative group">
            <div class="w-32 h-32 rounded-full overflow-hidden bg-gray-100 ring-4 ring-indigo-50 shadow-lg">
              <img
              ...
              <div
                v-else
                class="w-full h-full flex items-center justify-center bg-gradient-to-br from-indigo-500 to-purple-600 text-white text-4xl font-bold"
              >
              ...
              >
                <span class="text-white text-sm font-semibold bg-black/20 px-3 py-1 rounded-full border border-white/30">Change Avatar</span>
          ...
          <p class="text-sm text-gray-500 font-medium">Click image to upload new avatar</p>
        </div>

        <!-- Profile Form -->
        <form @submit.prevent="updateProfile" class="space-y-6 max-w-lg mx-auto w-full">
          <div>
            ...
            <input
              ...
              type="text"
              required
              class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all bg-gray-50/50 focus:bg-white"
            />
          </div>
          ...
          <div>
            ...
            <div class="relative">
                ...
                type="email"
                disabled
                class="w-full px-4 py-3 border border-gray-200 rounded-xl bg-gray-100/50 text-gray-500 cursor-not-allowed"
                />
            ...
            <p class="mt-2 text-xs text-gray-400">Email cannot be changed for security reasons.</p>
          </div>
          ...
          <transition enter-active-class="transition ease-out duration-200" leave-active-class="transition ease-in duration-150" enter-from-class="opacity-0 translate-y-2" enter-to-class="opacity-100 translate-y-0" leave-from-class="opacity-100 translate-y-0" leave-to-class="opacity-0 translate-y-2">
            <div v-if="message.text" :class="['p-4 rounded-xl text-sm font-medium flex items-center gap-2', message.type === 'success' ? 'bg-green-50 text-green-700 border border-green-100' : 'bg-red-50 text-red-700 border border-red-100']">
